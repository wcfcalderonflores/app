...
} elseif ($_instance->childHasBeenRendered('v8xGuMr')) {
    $componentId = $_instance->getRenderedChildComponentId('v8xGuMr');
    $componentTag = $_instance->getRenderedChildComponentTagName('v8xGuMr');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('v8xGuMr');
} else {
    $response = \Livewire\Livewire::mount('personal.personal-list');
    $html = $response->html();
    $_instance->logRenderedChild('v8xGuMr', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
