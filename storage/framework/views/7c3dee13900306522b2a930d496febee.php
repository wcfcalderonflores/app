...
} elseif ($_instance->childHasBeenRendered('l524797856-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l524797856-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l524797856-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l524797856-0');
} else {
    $response = \Livewire\Livewire::mount('modals.create-update-time-table');
    $html = $response->html();
    $_instance->logRenderedChild('l524797856-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
  </div>
<?php /**PATH C:\xampp\htdocs\control-personal\resources\views/livewire/time-table/time-table-list.blade.php ENDPATH**/ ?>