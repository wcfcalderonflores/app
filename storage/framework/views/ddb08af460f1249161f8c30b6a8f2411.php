      ...
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            <div class="row mt-3" >
              <div  class="col-md-5">
                <input class="form-control" type="text" placeholder="Buscar Persona"  />
                <ul id="resultados"></ul>
              </div>
              <div  class="col-md-3">
...
<?php /**PATH C:\xampp\htdocs\control-personal\resources\views/livewire/time-calendar/time-calendar-list.blade.php ENDPATH**/ ?>