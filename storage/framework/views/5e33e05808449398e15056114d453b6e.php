...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6">
                    ...
                    <input type="date" name="FechNac" class="form-control <?php echo e($errors->has("fecha_nac") ? 'is-invalid' : ''); ?>" id="validationCustom02" wire:model.defer="data.fecha_nac" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6">
                    ...
                    <input type="date" name="fecha_ingreso" class="form-control <?php echo e($errors->has("fecha_ingreso") ? 'is-invalid' : ''); ?>" id="validationCustom02" wire:model.defer="data.fecha_ingreso" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control <?php echo e($errors->has("direccion_act") ? 'is-invalid' : ''); ?>" id="validationCustom02" wire:model.defer="data.direccion_act" required>
                    <?php $__errorArgs = ['direccion_act.'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control <?php echo e($errors->has("correo") ? 'is-invalid' : ''); ?>" id="validationCustom02" wire:model.defer="data.correo" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control <?php echo e($errors->has("celular") ? 'is-invalid' : ''); ?>" id="validationCustom02" wire:model.defer="data.celular" required>
...
<?php /**PATH C:\xampp\htdocs\control-personal\resources\views/livewire/modals/create-update-personal.blade.php ENDPATH**/ ?>