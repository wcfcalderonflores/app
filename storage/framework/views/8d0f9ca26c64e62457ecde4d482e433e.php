...
} elseif ($_instance->childHasBeenRendered('ikY7pkj')) {
    $componentId = $_instance->getRenderedChildComponentId('ikY7pkj');
    $componentTag = $_instance->getRenderedChildComponentTagName('ikY7pkj');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ikY7pkj');
} else {
    $response = \Livewire\Livewire::mount('time-log.time-log');
    $html = $response->html();
    $_instance->logRenderedChild('ikY7pkj', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\control-personal\resources\views/timeLog/extract.blade.php ENDPATH**/ ?>