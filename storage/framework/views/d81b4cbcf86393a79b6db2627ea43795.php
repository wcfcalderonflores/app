...
} elseif ($_instance->childHasBeenRendered('1ENDlUo')) {
    $componentId = $_instance->getRenderedChildComponentId('1ENDlUo');
    $componentTag = $_instance->getRenderedChildComponentTagName('1ENDlUo');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('1ENDlUo');
} else {
    $response = \Livewire\Livewire::mount('sub-area.sub-area-list');
    $html = $response->html();
    $_instance->logRenderedChild('1ENDlUo', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
