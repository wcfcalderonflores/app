...
} elseif ($_instance->childHasBeenRendered('WNxsg0J')) {
    $componentId = $_instance->getRenderedChildComponentId('WNxsg0J');
    $componentTag = $_instance->getRenderedChildComponentTagName('WNxsg0J');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('WNxsg0J');
} else {
    $response = \Livewire\Livewire::mount('time-calendar.time-calendar-list');
    $html = $response->html();
    $_instance->logRenderedChild('WNxsg0J', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
