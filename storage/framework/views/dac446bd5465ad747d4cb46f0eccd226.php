...
} elseif ($_instance->childHasBeenRendered('rxd6waZ')) {
    $componentId = $_instance->getRenderedChildComponentId('rxd6waZ');
    $componentTag = $_instance->getRenderedChildComponentTagName('rxd6waZ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('rxd6waZ');
} else {
    $response = \Livewire\Livewire::mount('time-log.timelog-personal');
    $html = $response->html();
    $_instance->logRenderedChild('rxd6waZ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
<?php /**PATH C:\Users\WILLIAN\Documents\GitHub\app\resources\views/timeLog/personal.blade.php ENDPATH**/ ?>