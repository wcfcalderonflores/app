...
} elseif ($_instance->childHasBeenRendered('l3907804260-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3907804260-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3907804260-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3907804260-0');
} else {
    $response = \Livewire\Livewire::mount('modals.create-update-time-table');
    $html = $response->html();
    $_instance->logRenderedChild('l3907804260-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
  </div>
<?php /**PATH C:\Users\WILLIAN\Documents\GitHub\app\resources\views/livewire/time-table/time-table-list.blade.php ENDPATH**/ ?>