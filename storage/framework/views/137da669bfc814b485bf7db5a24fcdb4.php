    ...
    <div class="card-body">
      ...
      <form class="row g-3" wire:submit.prevent="extractTimeLog">
        <div class="col-md-5">
          ...
          <input type="date" class="form-control" id="inputName5" wire:model.defer="startFech">
        </div>
        <div class="col-md-5">
...
<?php /**PATH E:\proyectos-netbeans\proyecto laravel\control-personal\resources\views/livewire/time-log/time-log.blade.php ENDPATH**/ ?>