...
} elseif ($_instance->childHasBeenRendered('wABG1vw')) {
    $componentId = $_instance->getRenderedChildComponentId('wABG1vw');
    $componentTag = $_instance->getRenderedChildComponentTagName('wABG1vw');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('wABG1vw');
} else {
    $response = \Livewire\Livewire::mount('time-log.timelog-personal');
    $html = $response->html();
    $_instance->logRenderedChild('wABG1vw', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\control-personal\resources\views/timeLog/personal.blade.php ENDPATH**/ ?>